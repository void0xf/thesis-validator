...
public sealed class ListIndentationConsistencyRule : ValidationRule<ListIndentationConsistencyRuleOptions>
{
    ...
    public ListIndentationConsistencyRule(ModernListAnalyzer? listAnalyzer = null)
    {
    ...
    private static IEnumerable<RuleProblem> ValidateIndentationConsistency(ModernListGroup list)
    {
        ...
        foreach (var levelGroup in itemsByLevel)
        {
            ...
            {
                var preview = TextExtractionService.Truncate(item.Text, 40);
