...
public sealed class DocumentSession
{
    ...
    public EditableDocument OpenEditableCopy(Stream stream)
    {
        ...
        return new EditableDocument(document, memoryStream);
    }
    ...
    public MemoryStream SaveAnnotated(WordprocessingDocument document)
    {
        try
        {
            ...
            return CommentWriter.SaveDocumentWithComments(document);
        }
