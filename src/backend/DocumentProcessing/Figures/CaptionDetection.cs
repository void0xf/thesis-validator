...
public static class CaptionDetection
{
    ...
    public static bool UsesDedicatedCaptionStyle(WordprocessingDocument document, Paragraph paragraph)
    {
        var styleId = StyleResolver.GetParagraphStyleId(paragraph);
        var styleName = StyleResolver.GetStyleName(document, styleId);
    ...
    {
        return StyleResolver.GetParagraphStyleId(paragraph) ?? "Normal";
    }

    public static string GetCaptionStyleLabel(WordprocessingDocument document, Paragraph paragraph)
    {
        var styleId = StyleResolver.GetParagraphStyleId(paragraph);
        var styleName = StyleResolver.GetStyleName(document, styleId);
